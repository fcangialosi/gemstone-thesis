...
\section{Identification of Major Accomplishments}

\todo{So, I've been thinking about the organization of the conclusion as a whole.  It appears that the structure follows this basic flow: 1 - We have demonstrated capabilities important to making a WPT system. 2 - We have made X achievements that mean Y. 3 - Future work. I suggest reordering in the order 2, 1, 3, and changing the subtitles (in order 2,1,3 to ``Contributions'', ``Evaluating Time Reversal as a Wireless Power Transfer Method'', and ``Final Words/Future Work''}
...
\section{Integration of Various Accomplishments Together}
