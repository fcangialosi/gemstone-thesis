...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{numerical/input-wave}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{numerical/cst-diode}
\caption[CST diode circuit model]{CST diode circuit model}
\label{fig:numerical-cst-diode}
\end{figure}
\todo{Can we shrink this?  It's far too large}
...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{numerical/iv-curves}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{numerical/room-model-a}
\caption[The Room Model]{Illustrates the geometry of the simulation.}
