\chapter{Appendix A: Spatial Profile Fit Parameters}
{\tiny
\begin{center}
\begin{equation}
\label{eq:vxrestate}
...
\end{equation}
		...
		\end{tabular}
		\newline\newline
		\caption{The table above displays the fit parameters for the spatial profiles described in section~\ref{sec:spatial-profile}. The upper and lower bounds referenced in the table are the bounds for the confidence intervals for the fir parameters to $2\sigma$.}
	\end{center}
\par}
\clearpage
\newpage
