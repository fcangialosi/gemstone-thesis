...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1.05\linewidth]{overlapping/50_sona}
  \caption{Sonas}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1.05\linewidth]{overlapping/50_recon}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1.05\linewidth]{overlapping/300_sona}
  \caption{Sonas}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=1.05\linewidth]{overlapping/300_recon}
  \caption{Reconstructions}
\end{subfigure}
